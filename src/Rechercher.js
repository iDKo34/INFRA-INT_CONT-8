...
// Fonction rechercher prend maintenant deux paramètres : produitsDatabase et motsCles
function rechercher(produitsDatabase, motsCles) {
...
// Exportez la fonction rechercher
